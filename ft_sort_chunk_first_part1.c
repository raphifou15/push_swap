...
/*   Updated: 2021/08/22 00:08:44 by rkhelif          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_value_for_action a, void (**ptr)(t_list **list1, t_list **list2))
{
	if (a.chunk == 1 && a.m > 0)
	{
		...
		a.v2 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + a.m - (a.m / 5)));
		a.v3 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + a.m));
		a.v4 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + 1));
	}
	else
	{
		a.v1 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + 20));
		a.v2 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + 85 - 20));
		a.v3 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + 85));
		a.v4 = ft_find_the_elem_value_need(list1, 0, 0, (a.level + 1));
	}
	while (a.i != -1)
	{
