...
/*   Updated: 2021/08/23 23:09:39 by rkhelif          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_check_duplicata_3(char **argv, int argc, t_duplicata d,
						char *tab);
...
int					ft_find_middle_elem(t_list **list, int nbr, long index,
						int size);

t_value_for_action	ft_init_action(t_list **list1, t_list **list2);
int					ft_checklist_is_ordered_and_list_b_empty(t_list **list1,
						t_list **list2);
...
int					ft_check_if_there_value_less(t_list **list1,
						t_value_for_action a);
...
int					ft_find_the_less_count_and_return_action(t_count c,
						t_list **list, t_value_for_action a);
...
int					ft_check_if_there_value_more(t_list **list1,
						t_value_for_action a);
...
int					ft_find_the_elem_value_need(t_list **list, int nbr,
						long index, int elem);
...
void				ft_check_the_list_before_push(t_list **list1,
						t_list **list2, t_value_for_action a,
						void (**ptr)(t_list **list1, t_list **list2));
